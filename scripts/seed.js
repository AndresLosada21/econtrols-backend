  ...
  const facultyMembers = [
    {
      ...
      bio: "Pesquisador líder do grupo e-Controls, especialista em teoria de controle e sistemas dinâmicos. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      shortBio:
        "Especialista em controle de sistemas dinâmicos e automação industrial.",
    ...
    },
    {
      ...
      bio: "Co-líder do e-Controls, especialista em inteligência computacional e machine learning aplicado a controle. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
      shortBio:
        "Especialista em inteligência computacional aplicada a sistemas de controle.",
      ...
      googleScholarUrl:
        "https://scholar.google.com/citations?user=renanmedeiros",
    ...
    },
    {
      ...
      bio: "Pesquisador sênior em controle de sistemas robóticos e supervisão de processos. Lorem ipsum dolor sit amet.",
    ...
    },
    {
      ...
      bio: "Especialista em automação industrial e indústria 4.0. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
      shortBio:
        "Pesquisador em automação industrial e tecnologias da indústria 4.0.",
    ...
    },
    {
      ...
      bio: "Especialista em controle tolerante a falhas e diagnóstico de sistemas. Lorem ipsum dolor sit amet.",
      ...
      googleScholarUrl:
        "https://scholar.google.com/citations?user=rafaelmendonca",
    ...
    },
    {
      ...
      bio: "Especialista em sistemas elétricos de potência e geração distribuída. Lorem ipsum dolor sit amet.",
      shortBio:
        "Pesquisador em sistemas elétricos de potência e energia renovável.",
    ...
    },
    {
      ...
      bio: "Especialista em teoria de controle e aplicações industriais. Lorem ipsum dolor sit amet.",
      ...
      googleScholarUrl:
        "https://scholar.google.com/citations?user=florindoayres",
    ...
    },
    {
      ...
      bio: "Especialista em robótica colaborativa e sistemas autônomos. Lorem ipsum dolor sit amet.",
      ...
      googleScholarUrl:
        "https://scholar.google.com/citations?user=lauraribeiro",
    ...
    },
    {
      ...
      bio: "Especialista em sistemas elétricos de potência e mobilidade elétrica. Lorem ipsum dolor sit amet.",
      ...
      googleScholarUrl:
        "https://scholar.google.com/citations?user=alessandrotrindade",
    ...
    },
    {
      ...
      bio: "Especialista em supervisão de processos e controle industrial. Lorem ipsum dolor sit amet.",
    ...
    {
      fullName: "Lucas Carvalho Cordeiro",
      displayName: "Lucas Cordeiro",
      role: "Pesquisador Permanente",
      email: "lucascordeiro@ufam.edu.br",
      bio: "Especialista em supervisão e segurança de sistemas dinâmicos. Lorem ipsum dolor sit amet.",
      shortBio: "Pesquisador em confiabilidade e segurança de processos.",
      phone: "+55 92 3305-4705",
      room: "Sala 133",
      hIndex: 6,
      ...
      googleScholarUrl:
        "https://scholar.google.com/citations?user=lucascordeiro",
      lattesUrl: "http://lattes.cnpq.br/1234567890123456",
      orcidUrl: "https://orcid.org/0000-0000-0000-0010",
      linkedinUrl: "https://linkedin.com/in/lucascordeiro",
      showOnHomepage: false,
      displayOrder: 11,
      isActive: true,
    },
    {
      fullName: "Pedro Henrique Silva Coutinho",
      displayName: "Pedro Coutinho",
      role: "Pesquisador Permanente",
      email: "pedrocoutinho@ufam.edu.br",
      bio: "Especialista em sistemas inteligentes e machine learning. Lorem ipsum dolor sit amet.",
      shortBio: "Pesquisador em inteligência computacional para controle.",
      phone: "+55 92 3305-4706",
      room: "Sala 134",
      hIndex: 5,
      ...
      googleScholarUrl:
        "https://scholar.google.com/citations?user=pedrocoutinho",
      lattesUrl: "http://lattes.cnpq.br/2345678901234567",
      orcidUrl: "https://orcid.org/0000-0000-0000-0011",
      linkedinUrl: "https://linkedin.com/in/pedrocoutinho",
      showOnHomepage: false,
      displayOrder: 12,
      isActive: true,
    },
    {
      fullName: "Luiz Alberto Queiroz Cordovil Júnior",
      displayName: "Luiz Cordovil",
      role: "Pesquisador Permanente",
      email: "luizcordovil@ufam.edu.br",
      bio: "Especialista em cibersegurança e controle de sistemas. Lorem ipsum dolor sit amet.",
      shortBio:
        "Pesquisador em cibersegurança aplicada a sistemas de controle.",
      phone: "+55 92 3305-4707",
      room: "Sala 135",
      hIndex: 4,
      ...
      googleScholarUrl:
        "https://scholar.google.com/citations?user=luizcordovil",
      lattesUrl: "http://lattes.cnpq.br/3456789012345678",
      orcidUrl: "https://orcid.org/0000-0000-0000-0012",
      linkedinUrl: "https://linkedin.com/in/luizcordovil",
      showOnHomepage: false,
      displayOrder: 13,
      isActive: true,
    },
    {
      fullName: "Rodrigo Farias Araújo",
      displayName: "Rodrigo Araújo",
      role: "Pesquisador Permanente",
      email: "rodrigoaraujo@ufam.edu.br",
      bio: "Especialista em teoria de controle e aplicações. Lorem ipsum dolor sit amet.",
      shortBio: "Pesquisador em teoria de controle avançada.",
      phone: "+55 92 3305-4708",
      room: "Sala 136",
      hIndex: 7,
      ...
      googleScholarUrl:
        "https://scholar.google.com/citations?user=rodrigoaraujo",
      lattesUrl: "http://lattes.cnpq.br/4567890123456789",
      orcidUrl: "https://orcid.org/0000-0000-0000-0013",
      linkedinUrl: "https://linkedin.com/in/rodrigoaraujo",
      showOnHomepage: false,
      displayOrder: 14,
      isActive: true,
    },
    {
      ...
      displayName: "Rômulo Rodrigues",
      role: "Pesquisador Permanente",
      email: "romulorodriguesteixeira@ufam.edu.br",
      bio: "Especialista em robótica móvel e navegação autônoma. Lorem ipsum dolor sit amet.",
      shortBio: "Pesquisador em robôs móveis autônomos.",
      phone: "+55 92 3305-4709",
      room: "Sala 137",
      hIndex: 5,
      ...
      googleScholarUrl:
        "https://scholar.google.com/citations?user=romulorodriguesteixeira",
      lattesUrl: "http://lattes.cnpq.br/5678901234567890",
      orcidUrl: "https://orcid.org/0000-0000-0000-0014",
    ...
    {
      fullName: "Vicente Ferreira de Lucena Junior",
      displayName: "Vicente Lucena",
      role: "Pesquisador Permanente",
      email: "vicentelucena@ufam.edu.br",
      bio: "Especialista em automação industrial e indústria 4.0. Lorem ipsum dolor sit amet.",
      shortBio: "Pesquisador em tecnologias da indústria 4.0.",
      phone: "+55 92 3305-4710",
      room: "Sala 138",
      hIndex: 4,
      totalPublications: 16,
      totalCitations: 85,
      specializationAreas: ["Indústria 4.0", "Automação", "Digitalização"],
      googleScholarUrl:
        "https://scholar.google.com/citations?user=vicentelucena",
      lattesUrl: "http://lattes.cnpq.br/6789012345678901",
      orcidUrl: "https://orcid.org/0000-0000-0000-0015",
      linkedinUrl: "https://linkedin.com/in/vicentelucena",
      showOnHomepage: false,
      displayOrder: 16,
      isActive: true,
    },
    {
      ...
      role: "Pesquisador Permanente",
      email: "joaoaranha@ufam.edu.br",
      bio: "Especialista em controle de robôs e sistemas robóticos. Lorem ipsum dolor sit amet.",
      shortBio: "Pesquisador em controle de sistemas robóticos.",
      phone: "+55 92 3305-4711",
      room: "Sala 139",
      hIndex: 6,
      ...
      googleScholarUrl: "https://scholar.google.com/citations?user=joaoaranha",
      lattesUrl: "http://lattes.cnpq.br/7890123456789012",
      orcidUrl: "https://orcid.org/0000-0000-0000-0016",
...
async function seedResearchLines(strapi) {
  ...
  const researchLines = [
    ...
    },
    {
      ...
      slug: "robotica",
      shortDescription:
        "Controle e navegação de robôs móveis autônomos aéreos e terrestres.",
      fullDescription:
      ...
      teachingCourses:
        "Cursos de robótica móvel, controle de robôs, inteligência artificial.",
      isActive: true,
      displayOrder: 4,
    },
    {
      ...
      practicalApplications:
        "Aplicações em indústrias de transformação e processos industriais.",
      teachingCourses:
        "Cursos de automação industrial, indústria 4.0, sistemas ciber-físicos.",
      isActive: true,
      displayOrder: 5,
    },
    {
  ...
  const projects = [
    {
      ...
      currentStatus:
        "Em desenvolvimento dos algoritmos de controle inteligente",
      objectives:
    ...
    },
    {
      ...
      impactLegacy:
        "Contribuição para a modernização da infraestrutura elétrica brasileira.",
      keywords: [
        "Redes Elétricas Inteligentes",
        "Supervisão",
        "Diagnóstico de Falhas",
    ...
    },
    {
      ...
      expectedResults:
        "Robôs autônomos desenvolvidos, patentes registradas e comercialização.",
      achievedResults:
        "Especificações técnicas definidas, protótipos iniciais desenvolvidos.",
    ...
    },
    {
      ...
      methodology:
        "Desenvolvimento teórico, simulação e validação experimental.",
      expectedResults:
        "Técnicas validadas experimentalmente, publicações científicas.",
      achievedResults:
        "Algoritmos desenvolvidos, testes experimentais realizados.",
...
async function seedPublications(strapi) {
  ...
  const publications = [
    ...
    {
      title:
        "Fault Detection and Diagnosis in Industrial Processes Using Machine Learning",
    ...
    },
    {
      ...
      authorsText:
        "Kenny Vinente dos Santos, Florindo Antonio de Carvalho Ayres Júnior",
      publicationType: "Journal Article",
      year: 2023,
    ...
    },
    {
      ...
      authorsText:
        "Pedro Henrique Silva Coutinho, Luiz Alberto Queiroz Cordovil Júnior",
      publicationType: "Conference Paper",
      year: 2022,
...
async function seedPartners(strapi) {
  ...
  const partners = [
    ...
    },
    {
      ...
      city: "Dresden",
      description:
        "Intercâmbio acadêmico e pesquisa colaborativa em controle de sistemas",
      collaborationType: [
    ...
    },
    {
      ...
      city: "Cambridge",
      description:
        "Parceria internacional em pesquisa avançada em controle e robótica",
...
async function seedNewsItems(strapi) {
  ...
  const newsItems = [
    {
      title:
        "e-Controls recebe financiamento do CNPq para projeto de controladores inteligentes",
...
Esta publicação representa um marco importante para o grupo e consolida sua posição na pesquisa internacional em controle de sistemas.`,
    ...
    {
      title:
        "Defesa de doutorado: Controle Inteligente de Processos Industriais",
